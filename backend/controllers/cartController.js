...
exports.addItemToCart = async (req, res) => {
    try {
        const { user_id, product_id, quantity, selected_count_id, color, price } = req.body;

        // Fetch the user's cart ID
        const cart_id = await cartModel.getUserCartId(user_id);

        // Add the item to the cart
        await cartModel.addItemToCart(cart_id, product_id, quantity, selected_count_id, color, price);
